    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          {/* Centered stage — logo + wordmark stack as one unit, perfectly aligned */}
          <div className="absolute inset-0 flex items-center justify-center px-6">
            <div className="relative flex flex-col items-center">
              {/* Converging particles — anchored to logo center */}
              {particles.map((p, i) => (
                <motion.div
                  key={`p-${i}`}
              ...
              {/* Expanding rings — anchored to logo center */}
              {[0, 0.25, 0.5].map((d, i) => (
                <motion.div
                  key={`r-${i}`}
                  ...
                  style={{
                    ...
                    borderWidth: 1,
                    borderStyle: "solid",
                    borderColor: "rgba(200,149,46,0.5)",
                  }}
              ...
              {/* Wordmark — sits a fixed gap below logo, centered */}
              <motion.div
              ...
              >
                <div
                  className="text-2xl sm:text-3xl font-bold tracking-[0.35em] sm:tracking-[0.4em] whitespace-nowrap"
                  style={{
                    fontFamily: "Sora, sans-serif",
                ...
                <div
                  className="text-[9px] sm:text-[10px] text-white/40 mt-3 uppercase whitespace-nowrap"
